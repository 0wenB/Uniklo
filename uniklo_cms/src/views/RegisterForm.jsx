    ...
    <>
      <section className="min-h-screen flex items-stretch text-white ">
        <div
          ...
          style={{
            backgroundImage:
              "url(https://images.unsplash.com/photo-1571865194649-6464b12a76e5?q=80&w=1586&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D)",
          }}
        >
          ...
          <div className="w-full px-24 z-10">
            ...
            <p className="text-3xl my-4">Or just be ordinary</p>
          </div>
        ...
        <div className="lg:w-1/2 w-full flex items-center justify-center text-center md:px-16 px-0 z-0 bg-[#F46956]">
